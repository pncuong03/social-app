...
import { Text, View, TouchableOpacity, Pressable, Image, TextInput } from "react-native";
    ...
    return (
        <MenuProvider>
            <View style={{
                ...
                <View style={{ borderBottomWidth: 1, marginTop: 40, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
